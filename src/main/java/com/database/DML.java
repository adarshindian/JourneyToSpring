...
public class DML {
	...
	//  PreparedStatement stt = con.prepareStatement("select email from personal where email=?"); 
	 PreparedStatement st = con.prepareStatement("insert into personal(name,address,contact_no,email,pass) values(?,?,?,?,?)"); 
	// stt.setString(1, c.getEmail());
//ResultSet rs= stt.executeQuery();
//if(rs.getRow()==1)
//if(rs.getString(1)==c.getEmail())
	//return 0;
